...
async def test_add_simple(literal_one, literal_two, dummy_eval_context):
    result = await arithmetic.AddFunction([literal_one, literal_two], role=Role.VALUE).eval(context=dummy_eval_context)
    assert result == 3
...
async def test_add_boolean(literal_one, literal_true, dummy_eval_context):
    result = await arithmetic.AddFunction([literal_one, literal_true], role=Role.VALUE).eval(context=dummy_eval_context)
    assert result == 2
...
async def test_sub_simple(literal_one, literal_two, dummy_eval_context):
    result = await arithmetic.SubFunction([literal_one, literal_two], role=Role.VALUE).eval(context=dummy_eval_context)
    assert result == -1


async def test_sub_boolean(literal_two, literal_true, dummy_eval_context):
    result = await arithmetic.SubFunction([literal_two, literal_true], role=Role.VALUE).eval(context=dummy_eval_context)
    assert result == 1
...
async def test_mul_simple(literal_two, literal_ten, dummy_eval_context):
    result = await arithmetic.MulFunction([literal_two, literal_ten], role=Role.VALUE).eval(context=dummy_eval_context)
    assert result == 20
...
async def test_mul_boolean(literal_two, literal_true, dummy_eval_context):
    result = await arithmetic.MulFunction([literal_two, literal_true], role=Role.VALUE).eval(context=dummy_eval_context)
    assert result == 2
...
async def test_div_integer(literal_ten, literal_two, dummy_eval_context):
    result = await arithmetic.DivFunction([literal_ten, literal_two], role=Role.VALUE).eval(context=dummy_eval_context)
    assert result == 5


async def test_div_float(literal_two, literal_ten, dummy_eval_context):
    result = await arithmetic.DivFunction([literal_two, literal_ten], role=Role.VALUE).eval(context=dummy_eval_context)
    assert result == 0.2


async def test_div_boolean(literal_ten, literal_true, literal_false, dummy_eval_context):
    result = await arithmetic.DivFunction([literal_ten, literal_true], role=Role.VALUE).eval(context=dummy_eval_context)
    assert result == 10
...
async def test_mod_integer(literal_ten, literal_two, dummy_eval_context):
    result = await arithmetic.ModFunction([literal_ten, literal_two], role=Role.VALUE).eval(context=dummy_eval_context)
    assert result == 0
...
async def test_mod_boolean(literal_ten, literal_true, literal_false, dummy_eval_context):
    result = await arithmetic.ModFunction([literal_ten, literal_true], role=Role.VALUE).eval(context=dummy_eval_context)
    assert result == 0
...
async def test_pow_integer(literal_ten, literal_two, dummy_eval_context):
    result = await arithmetic.PowFunction([literal_ten, literal_two], role=Role.VALUE).eval(context=dummy_eval_context)
    assert result == 100
...
async def test_pow_boolean(literal_ten, literal_true, literal_false, dummy_eval_context):
    result = await arithmetic.PowFunction([literal_ten, literal_true], role=Role.VALUE).eval(context=dummy_eval_context)
    assert result == 10
